  ...
  return (
    <div className="py-6 space-y-6">
      ...
      >
        ...
        {!useBorderedBox && (
          <div className="flex-1 flex items-center justify-center min-h-0 w-full" aria-hidden="true">
            <svg width="175" height="175" viewBox="-22 14 184 124" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          type="button"
          onClick={() => setUseBorderedBox((prev) => !prev)}
