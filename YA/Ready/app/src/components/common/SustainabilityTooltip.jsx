  ...
  return (
    <span ref={wrapperRef} className="relative inline-flex items-center gap-1">
      ...
      <span
        ...
        aria-label="Sustainability score information"
        className="cursor-help focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1 rounded inline-flex shrink-0 text-[11px] text-gray-600"
      >
        ⓘ
      </span>
      {visible &&
